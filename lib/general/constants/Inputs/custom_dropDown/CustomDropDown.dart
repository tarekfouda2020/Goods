// ignore_for_file: prefer_function_declarations_over_variables, duplicate_ignore, prefer_generic_function_type_aliases, file_names
...
class DropdownSearchState<T> extends State<DropdownSearch<T>> {
  ...
  Future<T?> _openBottomSheet(T? data) {
    return showModalBottomSheet<T>(
        ...
        context: context,
        builder: (ctx) {
          return _selectDialogInstance(data, defaultHeight: 400);
        });
  }
        ...
        items: [
          CustomPopupMenuItem(
            ...
            child: SizedBox(
              ...
              child: _selectDialogInstance(data, defaultHeight: 400),
            ),
          ),
        ]);
  }
